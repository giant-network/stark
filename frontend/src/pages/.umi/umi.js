...
import findRoute, {
  getUrlQuery,
} from '/Users/chengbin.wang/workspace/3myproject/stark/frontend/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/chengbin.wang/workspace/3myproject/stark/frontend',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
